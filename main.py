# 1 запустить файл main.py для создания базы данных
# 2 в консоль введсти следующее: pytest test_game.py --all
# Вывод: по условию задания проход составляет 600 тестов.
